...
var initSample = ( function() {
	...
	return function() {
      ...
      var request = new XMLHttpRequest()
        editor = setTimeout(function(){ CKEDITOR.replace( 'editor', {
      ...
      var idDoc = '4997'
        apiServ = 'https://www.dir-toolbox.com:8443/toolbox/documentocr.json?documentId='+ idDoc;
      request.open('GET', apiServ, true)

      request.onload = function () {
          var data = JSON.parse(this.response);
          numPag = 2//document.getElementById('pageNumber').value;
